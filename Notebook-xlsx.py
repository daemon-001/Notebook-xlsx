...
class App(ctk.CTk):
    def __init__(nmod):
        ...
        nmod.title("Notebook-xlsx")
        nmod.iconbitmap(resource_path('icon.ico'))
        ...
        def get_data():
            try:
                ...
                nmod.log_textbox.configure(state="normal")
                nmod.log_textbox.delete("1.0", "end")  # clears all logs from textbox
                nmod.log_textbox.insert("1.0", "Date                    Note description\n")
                ...
                for row in range(2, max_row_dat1+1):
                    ...
                    nmod.log_textbox.insert("2.0", log_data)
                    nmod.log_textbox.configure(state="disabled")
            except:
                nmod.log_textbox.configure(state="normal")
                nmod.log_textbox.delete("1.0", "end")  # clears all logs from textbox
        ...
        nmod.idea_label = ctk.CTkLabel(nmod, text="Input your note here").place(x=200, y=22)
        ...
        nmod.idea_button = ctk.CTkButton(nmod, text="View Notes", border_width=None, height=25, width=100, text_color=("gray10", "#DCE4EE"), command=get_data)
